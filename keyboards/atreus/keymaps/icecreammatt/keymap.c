...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY_PLN] = LAYOUT(
    ...
    KC_TRNS,     TO(QWERTY),KC_TRNS,   KC_LGUI,   KC_TRNS,  KC_TRNS, KC_TRNS,   KC_TRNS, MO(POK3R),KC_TRNS,  KC_TRNS,     KC_TRNS
  ),
  ...
  [COLEMAK_PLN] = LAYOUT(
    ...
    KC_TRNS,     TO(COLEMAK),KC_TRNS,  KC_LGUI,   KC_TRNS,  KC_TRNS, KC_TRNS,   KC_TRNS, MO(POK3R),KC_TRNS,   KC_TRNS,     KC_TRNS
  ),
  ...
  [NUMERIC] = LAYOUT( /* NUMERIC */
    ...
    KC_LSFT,        KC_NO,      KC_NO,      KC_NO,      KC_NO,                       KC_NO,      KC_1,    KC_2,     KC_3,    KC_EQL,
  ...
  [NUM_SPECIAL] = LAYOUT( /* NUM_SPECIAL */
    ...
    KC_LSFT,        KC_NO,      KC_NO,      KC_NO,      KC_NO,                       KC_NO,      KC_EXLM,    KC_AT,       KC_HASH,    KC_EQL,
