...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY] = LAYOUT(
    ...
    KC_NO,                  RESET,           KC_NO,            TD(LGUI_ALT),            LT(QWERTY_2,KC_SPC), LCTL_T(KC_TAB), LT(MOUSE,KC_ESC), LT(SYMBOL, KC_BSPC), KC_NO,     KC_NO,         KC_NO,      KC_NO
  ),
...
// add double tap to backspace to work as enter/return
