...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY] = LAYOUT(
    ...
    KC_NO,       KC_NO,               MO(Q_MIRYOKU),                LT(NUM_SPECIAL, KC_ESC),        KC_SPC,  LT(NUMERIC, KC_TAB), LT(NUMERIC, KC_ENT),              KC_BSPC,          MO(POK3R), ALL_T(KC_DEL),  LALT_T(KC_SCLN), KC_ENT
  ),
  ...
  [NUMERIC] = LAYOUT(
    ...
    KC_TAB,     KC_TRNS,  KC_PSCR,  KC_PAUS,  KC_TRNS,  KC_MINS,  KC_NO,                                    CG_NORM,    KC_VOLD,            ALL_T(KC_DEL),      LALT_T(KC_VOLU),    CG_SWAP
  ),
  ...
  [NUM_SPECIAL] = LAYOUT(
    ...
    KC_TAB,         LALT_T(KC_MINS),   KC_0,      KC_TRNS,  TO(STANDARD),     LCTL_T(KC_MINS),  LT(NUMERIC, KC_ESC),    KC_DEL,   ALL_T(KC_DEL),      ALL_T(KC_PIPE),  LALT_T(KC_PDOT),   KC_ENT
  ),

  // Pok3r - special characters and numbers
  [POK3R] = LAYOUT(
    KC_TILD,        KC_EXLM,            KC_LBRC,    KC_RBRC,    KC_PIPE,                                                    KC_PSLS,            KC_7,     KC_8,             KC_9,               KC_MINS,
