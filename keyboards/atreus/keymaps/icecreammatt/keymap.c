 ...
 * | A   | S   | D   | F   | G   |                      | H   | J   | K   | L   | ' " |
 * |-----+-----+-----+-----+-----+                      |-----+-----+-----+-----+-----|
 * |SHF/Z| X/AL| C   | V   | B   |                      | N   |M GUI| < ,C| >.AL|SHF/?|
 * `-----'-----'-----'-----'-----'                      `-----'-----'-----'-----'-----'
 *               .-------.-------.-------.      .-------.-------.
 ...
 * | `~  |  =  | [{  |  }] |     |                      |LEFT |DOWN | UP  |RGHT | ;:  |
 * |-----+-----+-----+-----+-----+                      |-----+-----+-----+-----+-----|
 * |SHFT |DEL/A|  -  |  +  |ALL+||                      |HOME |PGDN |PGUP | END |SHF\||
 * `-----'-----'-----'-----'-----'                      `-----'-----'-----'-----'-----'
 *               .-------.-------.-------.      .-------.-------.
...
* |-----+-----+-----+-----+-----|                      |-----+-----+-----+-----+-----|
* |QWERT|COLEM|GAME1|GAME2|     |                      |WH_L | M1  | M2  | M3  |WH_R |
* |-----+-----+-----+-----+-----+                      |-----+-----+-----+-----+-----|
* | F11 | F12 |Vol- |Vol+ |MUTE |                      |PLAY |WH_D |WH_U |RESET|SHF  |
* `-----'-----'-----'-----'-----'                      `-----'-----'-----'-----'-----'
*               .-------.-------.-------.      .-------.-------.
*               |       | (hold)|       |      |       |(hold) |
*               '-----------------------'      '-------'-------'
